...
export function headline(resolution: Resolution): string {
  switch (resolution.type) {
    ...
    case "lost":
      return (
        ":ghost: *No longer pending* — remote-hands restarted after this was " +
...
export function approvalFallback(request: ApprovalRequest): string {
